...
if(!['video-capture-probe.cjs','video-ui-smoke.cjs','video-long-probe.cjs','sop-ui-smoke.cjs','timeline-ui-smoke.cjs','editor-interaction-smoke.cjs','feishu-install-check.cjs'].includes(name))throw Error('Unknown test')
