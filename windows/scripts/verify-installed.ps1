...
if (-not $result.smartSelectionVerified -or -not $result.smartSelectionDisabledApplied -or -not $result.smartSelectionSettingUi.initial -or $result.smartSelectionSettingUi.saved) { throw "Installed smart-selection validation failed: $($result.smartSelectionPreview | ConvertTo-Json -Compress -Depth 5)." }
...
if (-not $result.editorInitialFitVerified -or -not $result.editorAnnotationVerified) { throw "Installed editor fit/annotation validation failed: fit=$($result.editorInitialFit | ConvertTo-Json -Compress); annotation=$($result.editorAnnotationVerified)." }
...
[pscustomobject]@{
  ...
  EditorInitialFit = "Visible={0}; Annotated={1}; Rendered={2}x{3}; Available={4}x{5}" -f $result.editorInitialFitVerified, $result.editorAnnotationVerified, $result.editorInitialFit.renderedWidth, $result.editorInitialFit.renderedHeight, $result.editorInitialFit.availableWidth, $result.editorInitialFit.availableHeight
